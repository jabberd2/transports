...
char* gg_failure_reason[] = {
    "RESOLVING",       /* nie znaleziono serwera */
    "CONNECTING",      /* nie można się połączyć */
    "INVALID",         /* serwer zwrócił nieprawidłowe dane */
    "READING",         /* zerwano połączenie podczas odczytu */
    "WRITING",         /* zerwano połączenie podczas zapisu */
    "PASSWORD",        /* nieprawidłowe hasło */
    "404",             /* XXX nieużywane */
    "TLS",             /* błąd negocjacji TLS */
    "NEED_EMAIL",      /* serwer rozłączył nas z prośbą o zmianę emaila */
